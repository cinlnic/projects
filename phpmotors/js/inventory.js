'use strict' 
 ...
 classificationList.addEventListener("change", function () { 
  ...
  let classIdURL = "/phpmotors/vehicles/index.php?login=getInventoryItems&classificationId=" + classificationId; 
  fetch(classIdURL) 
...
function buildInventoryList(data) { 
    ...
    data.forEach(function (element) { 
     ...
     dataTable += `<td><a href='/phpmotors/vehicles?login=mod&id=${element.invId}' title='Click to modify'>Modify</a></td>`; 
     dataTable += `<td><a href='/phpmotors/vehicles?login=del&id=${element.invId}' title='Click to delete'>Delete</a></td></tr>`; 
    }) 
    dataTable += '</tbody>'; 
